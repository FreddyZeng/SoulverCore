...
/// Whether this operation executes asynchronously
@property (nonatomic, readonly, getter=isAsynchronous) BOOL asynchronous;
/// Whether this operation is currently executing
@property (nonatomic, readonly, getter=isExecuting) BOOL executing;
/// Whether this operation has finished executing
@property (nonatomic, readonly, getter=isFinished) BOOL finished;
/// Starts the operation, transitioning to executing or finished if cancelled
- (void)start;
- (void)main;
